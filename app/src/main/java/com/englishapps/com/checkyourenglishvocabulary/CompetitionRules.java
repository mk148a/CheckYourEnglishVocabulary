...
public class CompetitionRules extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout lw1=(LinearLayout)findViewById(R.id.competition_ruleslinear);
        LinearLayout lw2=(LinearLayout)findViewById(R.id.competition_rulesaltlinear);
            ...
            for (int j = 0; j < 1; j++) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent();
                        i.setClass(CompetitionRules.this, compitation.class);
                        startActivity(i);}});
                if (j == 0)
                {
