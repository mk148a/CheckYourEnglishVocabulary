...
public class PlayWithFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.englishapps.com.checkyourenglishvocabulary.R.layout.activity_play_with_friend);
        LinearLayout anasayfa = (LinearLayout) findViewById(com.englishapps.com.checkyourenglishvocabulary.R.id.playwithyourfriend_anasayfa);
        LinearLayout orta = (LinearLayout) findViewById(com.englishapps.com.checkyourenglishvocabulary.R.id.playwithyourfriend_orta);
        LinearLayout alt = (LinearLayout) findViewById(com.englishapps.com.checkyourenglishvocabulary.R.id.playwithyourfriend_altlinear);
        anasayfa.setBackgroundDrawable(getResources().getDrawable(resimara(getString(com.englishapps.com.checkyourenglishvocabulary.R.string.playwithfriendbackground))));
        try {
            orta.addView(playwithyour_ortaview());
            alt.addView(playwithyour_altview());
    ...
    public View playwithyour_ortaview() throws IllegalAccessException {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                if (j == 0) {
                    ...
                    button.setId(com.englishapps.com.checkyourenglishvocabulary.R.id.playwithfriend_startbutton);
                } else if (j == 1) {
                    button.setBackgroundResource(resimara(getString(com.englishapps.com.checkyourenglishvocabulary.R.string.findbutton)));
                } else if (j == 2) {
    ...
    public View playwithyour_altview() throws IllegalAccessException {
        ArrayList<String> adad = new ArrayList<String>();
        adad.add("rank");
        adad.add("rules");
        adad.add("back");
                    ...
                    public void onClick(View v) {
                        ...
                        switch ((v.getTag().toString())) {
                            ...
                            case "back":
                                ...
                                i.setClass(PlayWithFriend.this, MainActivity.class);
                                startActivity(i);
                                break;
                        }
