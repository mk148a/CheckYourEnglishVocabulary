    ...
    void giriskontrol() {
        ...
        if (logout == false) {
            ...
            try {
                ...
                TextView usertxt = (TextView) findViewById(R.id.usernametxt);
...
//            altlinear.addView(altview());
            final Button singleplyr_btn = findViewById(R.id.btnSinglePlayer);
            singleplyr_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent go_singlepage = new Intent();
                    go_singlepage.setClass(MainActivity.this, singleplayer.class);
                    startActivity(go_singlepage);
                }
            });
            final Button multiplyr_btn = findViewById(R.id.btnMultiPlayer);
            multiplyr_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent go_multiplyr = new Intent();
                    go_multiplyr.setClass(MainActivity.this, Multiplayer.class);
                    startActivity(go_multiplyr);
                }
            });
